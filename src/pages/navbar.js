...
class Thing extends Component {
  state = { cartAmount: null }
  render() { 
    return ( <div>
      <Navbar collapseOnSelect expand="lg" bg="dark" variant="dark" className="navbarmaster">
        <Navbar.Brand>
          <Link to="/" className="navbarlink"><p className="navbarlink">History's Armory</p></Link>
        </Navbar.Brand>
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          <Nav className="mr-auto">
            ...
            <Nav>
              ...
              <Nav.Link>
                <Link to="/Sell" ><p className="navbarlink">For Craftsmen</p></Link>
              </Nav.Link>
            </Nav>
          </Nav>
          ...
          <Nav>
            <Nav.Link to="/Cart">
              <Link to="/Cart">
                  ...
                  <p className="navbarlink">{this.props.cartAmount} <i className="fa fa-shopping-cart" aria-hidden="true" ></i> </p>
                </div>
              </Link>
            </Nav.Link>
          </Nav>
